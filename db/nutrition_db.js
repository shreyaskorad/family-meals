...
const NUTRITION_DB = {
    ...
    // ========== INDIAN DISHES (with protein estimates per serving) ==========
    dishes: {
        breakfast: [
            { name: "Poha", proteinLevel: "Low", protein: 4 },
            { name: "Upma", proteinLevel: "Low", protein: 5 },
            { name: "Idli (2 pcs)", proteinLevel: "Low", protein: 4 },
            { name: "Dosa", proteinLevel: "Low", protein: 5 },
            { name: "Paratha (aloo)", proteinLevel: "Low", protein: 6 },
            { name: "Paratha (paneer)", proteinLevel: "High", protein: 15 },
            { name: "Omelette (2 eggs)", proteinLevel: "High", protein: 14 },
            { name: "Besan chilla", proteinLevel: "High", protein: 12 },
            { name: "Moong dal chilla", proteinLevel: "High", protein: 14 },
            { name: "Sabudana khichdi", proteinLevel: "Low", protein: 3 },
            { name: "Thalipeeth", proteinLevel: "Medium", protein: 8 },
            { name: "Misal pav", proteinLevel: "Medium", protein: 10 },
        ],
        lunch: [
            { name: "Dal tadka + rice", proteinLevel: "Medium", protein: 12 },
            { name: "Rajma chawal", proteinLevel: "Medium", protein: 14 },
            { name: "Chole chawal", proteinLevel: "Medium", protein: 13 },
            { name: "Kadhi chawal", proteinLevel: "Medium", protein: 8 },
            { name: "Chicken curry + roti", proteinLevel: "High", protein: 28 },
            { name: "Fish curry + rice", proteinLevel: "High", protein: 25 },
            { name: "Egg curry + rice", proteinLevel: "High", protein: 16 },
            { name: "Palak paneer + roti", proteinLevel: "High", protein: 18 },
            { name: "Paneer butter masala", proteinLevel: "High", protein: 16 },
            { name: "Aloo gobi + roti", proteinLevel: "Low", protein: 6 },
            { name: "Bhindi masala + roti", proteinLevel: "Low", protein: 5 },
            { name: "Soya chunks curry", proteinLevel: "High", protein: 22 },
            { name: "Mutton curry + roti", proteinLevel: "High", protein: 30 },
            { name: "Prawn curry + rice", proteinLevel: "High", protein: 26 },
            { name: "Biryani (chicken)", proteinLevel: "High", protein: 25 },
            { name: "Biryani (veg)", proteinLevel: "Low", protein: 8 },
            { name: "Khichdi", proteinLevel: "Medium", protein: 10 },
        ],
        dinner: [
            { name: "Butter chicken", proteinLevel: "High", protein: 28 },
            { name: "Tandoori chicken", proteinLevel: "High", protein: 35 },
            { name: "Chicken tikka", proteinLevel: "High", protein: 30 },
            { name: "Fish fry", proteinLevel: "High", protein: 22 },
            { name: "Prawn masala", proteinLevel: "High", protein: 24 },
            { name: "Mutton biryani", proteinLevel: "High", protein: 28 },
            { name: "Paneer tikka", proteinLevel: "High", protein: 18 },
            { name: "Dal makhani", proteinLevel: "Medium", protein: 12 },
            { name: "Naan + any curry", proteinLevel: "Varies", protein: 0 },
        ],
        snacks: [
            { name: "Samosa (2 pcs)", proteinLevel: "Low", protein: 4 },
            { name: "Vada pav", proteinLevel: "Low", protein: 5 },
            { name: "Pani puri (6 pcs)", proteinLevel: "Low", protein: 3 },
            { name: "Bhel puri", proteinLevel: "Low", protein: 4 },
            { name: "Chicken momos (6 pcs)", proteinLevel: "High", protein: 15 },
            { name: "Paneer tikka (6 pcs)", proteinLevel: "High", protein: 16 },
            { name: "Egg sandwich", proteinLevel: "High", protein: 12 },
            { name: "Cheese sandwich", proteinLevel: "Medium", protein: 8 },
            { name: "Sprout chaat", proteinLevel: "Medium", protein: 8 },
            { name: "Peanut chikki", proteinLevel: "Medium", protein: 10 },
        ]
    }
};
